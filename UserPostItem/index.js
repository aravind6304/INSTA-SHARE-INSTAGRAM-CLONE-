      ...
      <div className="social_div">
        {isLiked ? (
          <button
            ...
            aria-label="Unlike Post" // Added aria-label
            type="button"
        ...
        <button aria-label="Comment" type="button" className="icon_button">
          <FaRegComment className="icon" />
        </button>
        <button aria-label="Share" type="button" className="icon_button">
